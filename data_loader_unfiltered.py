...
def load_data():
    ...
    imu_aligned = imu_df.reindex(target_idx, method='nearest')
    gyro_aligned = gyro_df.reindex(target_idx, method='nearest')
    ...
    onboard_pose_aligned = onboard_df.reindex(target_idx, method='nearest')
