...
# from data_loader_unfiltered import load_data
...
from training.lstm.bi_lstm_training import train_bilstm
from training.lstm.lstm_training import train_lstm
from training.ltc.ltc_training import train_ltc
from training.ltc.ltc_training_k_fold import train_ltc_k_folds
...
def main():
    ...
    # train_bilstm(X_spatial[0], y, device)
   # train_ltc_k_folds(X_spatial[0], y, 5, device)
