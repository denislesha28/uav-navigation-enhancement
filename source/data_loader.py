...
def load_ground_truth(path_appendix):
    gt_positions = pd.read_csv(path_appendix + "AGZ/log_files/GroundTruthAGL.csv", index_col="imgid")
    img_timestamps = pd.read_csv(path_appendix + "AGZ/log_files/GroundTruthAGM.csv", index_col="Timpstemp")
...
def load_data(path_appendix=""):
    ...
    # Load raw data
    imu_df = pd.read_csv(
        path_appendix + 'AGZ/log_files/RawAccel.csv',
        index_col="Timpstemp",
    ...
    gyro_df = pd.read_csv(
        path_appendix +'AGZ/log_files/RawGyro.csv',
        index_col="Timpstemp",
        usecols=['Timpstemp', ' x', ' y', ' z', ' temperature']
    )
    ...
    gps_df = pd.read_csv(
        path_appendix +'AGZ/log_files/OnboardGPS.csv',
        index_col="Timpstemp",
    ...
    onboard_df = pd.read_csv(
        path_appendix +'AGZ/log_files/OnboardPose.csv',
        index_col="Timpstemp",
        usecols=[
            'Timpstemp',
    ...
    gt_df = load_ground_truth(path_appendix)
